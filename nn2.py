...
train_data = pd.read_csv('mnist_train_0_4.csv', header = None)
test_data = pd.read_csv('mnist_test_0_4.csv', header = None)

#print(train_data.shape) #30596x785
#print(test_data.shape) #5139x785
